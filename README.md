...
[![GoDoc](https://pkg.go.dev/badge/github.com/Gealber/solana-go?status.svg)](https://pkg.go.dev/github.com/Gealber/solana-go@v1.12.0?tab=doc)
[![GitHub tag (latest SemVer pre-release)](https://img.shields.io/github/v/tag/gagliardetto/solana-go?include_prereleases&label=release-tag)](https://github.com/Gealber/solana-go/releases)
[![Build Status](https://github.com/Gealber/solana-go/workflows/tests/badge.svg?branch=main)](https://github.com/Gealber/solana-go/actions?query=branch%3Amain)
[![TODOs](https://badgen.net/https/api.tickgit.com/badgen/github.com/Gealber/solana-go/main)](https://www.tickgit.com/browse?repo=github.com/Gealber/solana-go&branch=main)
[![Go Report Card](https://goreportcard.com/badge/github.com/Gealber/solana-go)](https://goreportcard.com/report/github.com/Gealber/solana-go)
...
**If you're looking for a SERUM library, you can check out [gagliardetto/serum-go](https://github.com/gagliardetto/serum-go) ([./programs/serum](https://github.com/Gealber/solana-go/tree/main/programs/serum) is deprecated.**)
...
```bash
$ cd my-project
$ go get github.com/Gealber/solana-go@v1.12.0
```
...
You can wait for a transaction confirmation using the `github.com/Gealber/solana-go/rpc/sendAndConfirmTransaction` package tools (for a complete example: [see here](#transfer-sol-from-one-wallet-to-another-wallet))
...
import (
	...
	lookup "github.com/Gealber/solana-go/programs/address-lookup-table"
...
import (
  ...
  "github.com/Gealber/solana-go"
  "github.com/Gealber/solana-go/programs/system"
  "github.com/Gealber/solana-go/rpc"
...
import (
  ...
  "github.com/Gealber/solana-go/rpc"
  "github.com/Gealber/solana-go/rpc/jsonrpc"
)
...
import (
  ...
  "github.com/Gealber/solana-go/programs/system"
  "github.com/Gealber/solana-go/rpc"
  confirm "github.com/Gealber/solana-go/rpc/sendAndConfirmTransaction"
  "github.com/Gealber/solana-go/rpc/jsonrpc"
...
import (
  ...
  "github.com/davecgh/go-spew/spew"
  bin "github.com/gagliardetto/binary"
  solana "github.com/Gealber/solana-go"
  "github.com/Gealber/solana-go/programs/token"
  "github.com/Gealber/solana-go/rpc"
)
